...
export class Prs {
    // Duas fontes, porque uma sozinha mente:
    //  - a branch local acha o PR do repo clonado cuja branch é exatamente o ID
    //  - a busca na org acha o resto: repo NÃO clonado aqui (o gitops), e branch com sufixo
    //    (`UND-1638-envelope`, `UND-1638-hml`), que a igualdade exata descarta
    async doChamado(chamado, projetos) {
        ...
        const peso = { OPEN: 0, MERGED: 1, CLOSED: 2 };
        return lista.sort((a, b) => (peso[a.estado] ?? 3) - (peso[b.estado] ?? 3));
    }
